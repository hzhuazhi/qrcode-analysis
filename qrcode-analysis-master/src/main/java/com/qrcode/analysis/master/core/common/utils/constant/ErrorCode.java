...
public class ErrorCode {
    ...
    public enum ENUM_ERROR {
        ...
        D00035("D00035", "错误,请重试!", "更新用户出码开关时,开关类型数据为空!"),
        ...
        DC00046("DC00046", "余额过少,无法创建新群,请您充值!", "根据余额获取群名称时,用户余额已小于策略部署的创建群的保底金额!"),
        DC00047("DC00047", "您的余额可支撑的有效群数量已到达上限!", "根据余额获取群名称时,余额支撑的有效群已到达上限!"),
        DC00048("DC00048", "错误,请重试!", "根据余额获取群名称时,筛选出来的小微数据为空!"),
         ...
         * P打头表示池子的错误
         **********************************************/
        P00001("P00001", "错误,请重试!", "获取用户在池子中抢单状态时,所有数据都为空!"),

        P00002("P00002", "错误,请重试!", "更新抢单池状态时,所有数据都为空!"),
        P00003("P00003", "错误,请重试!", "更新抢单池状态时,抢单行为数据为空!"),
        P00004("P00004", "错误,请重试!", "更新抢单池状态时,根据did获取用户数据为空!"),
        P00005("P00005", "余额过少,请您充值!", "更新抢单池状态时,用户余额数据为空!"),
        P00006("P00006", "余额过少,请您充值!", "更新抢单池状态时,用户余额少于策略里面的最低标准!"),
        P00007("P00007", "暂无可用的有效群码,请创建新的群!", "更新抢单池状态时,用户暂无有效群!"),
        P00008("P00008", "您已处于抢单中!", "更新抢单池状态时,用户已经存在在抢单等待中!"),
        P00009("P00009", "您已处于抢单中!", "更新抢单池状态时,用户已经存在在抢单进行中!"),
        ...
        H00003("H00003", "错误,请重试!", "获取要解析二维码数据时,所有数据都为空!"),
        H00004("H00004", "错误,请重试!", "获取要解析二维码数据时,小微主键ID与微信原始ID都为空!"),

        H00005("H00005", "错误,请重试!", "解析更新用户收款账号二维码时,所有数据都为空!"),
        H00006("H00006", "错误,请重试!", "解析更新用户收款账号二维码时,解析的主键ID数据为空!"),
        H00007("H00007", "错误,请重试!", "解析更新用户收款账号二维码时,小微ID数据为空!"),
        H00008("H00008", "错误,请重试!", "解析更新用户收款账号二维码时,收款账号ID数据为空!"),
        H00009("H00009", "错误,请重试!", "解析更新用户收款账号二维码时,数据是否可正常解析数据为空!"),
        H00010("H00010", "错误,请重试!", "解析更新用户收款账号二维码时,解析的二维码数据为空!"),
